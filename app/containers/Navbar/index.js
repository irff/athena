        ...
        <div className="row expanded">
          <div className="small-12 columns">
            ...
            <div className="show-for-small hide-for-large">
              <Navlink isCurrentElement={window.location.pathname === '/mahasiswa' || window.location.pathname === '/mahasiswa/'} handleRoute={() => this.navOnClick('/mahasiswa')}><span className={globalStyles.icondashboard} /></Navlink>
